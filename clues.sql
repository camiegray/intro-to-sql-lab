...
SELECT * FROM countries WHERE continent = 'Europe' ORDER BY population ASC LIMIT 1;
...
SELECT * FROM cities WHERE name LIKE 'Serra%' AND countrycode = 'BRA';
...
SELECT * FROM cities WHERE name = 'Brasilia' AND countrycode = 'BRA';
